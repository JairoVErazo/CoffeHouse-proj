...
const Page = () => {
  ...
  const handlePrintRecibo = async (e) => {
    ...
    try {
      ...
      swal({
        icon: "error",
        text: `Hubo un problema al guardar la factura. Por favor, inténtelo de nuevo. Detalles del error: ${error.response ? error.response.data : error.message}`,
      });
    }
  };
    ...
    <div className="flex justify-center" style={{ color: "#94303c" }}>
      ...
      >
        <div className="flex justify-center">
          <h1 className="text-center text-6xl mb-12" style={{ color: "#94303c" }}>
            Orden # {idOrden}
          </h1>
        </div>
